...
@pytest.fixture
def number():
    return {'Дата операции': '22.07.2020 10:19:29', 'Дата платежа': '22.07.2020', 'Номер карты': nan, 'Статус': 'OK', 'Сумма операции': -100.0, 'Валюта операции': 'RUB', 'Сумма платежа': -100.0, 'Валюта платежа': 'RUB', 'Кэшбэк': nan, 'Категория': 'Мобильная связь', 'MCC': nan, 'Описание': 'МТС Mobile +7 985 111-11-11', 'Бонусы (включая кэшбэк)': 0, 'Округление на инвесткопилку': 0, 'Сумма операции с округлением': 100.0}